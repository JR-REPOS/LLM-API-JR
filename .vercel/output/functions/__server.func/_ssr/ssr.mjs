...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DwHQbjpx.mjs");
...
var manifest = { "6e605ce06e679b1c26776744e9fde220cf3c4ccc0cd6a7cf67f29fdf1b5e0aca": {
	functionName: "searchDocsLibraries_createServerFn_handler",
	importer: () => import("./search.functions-C8OhKGPq.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BqQLKK7v.mjs").then((n) => n.t),
